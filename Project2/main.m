...
for i=1:12
    ...
    FilmCord2x(i)=FilmCord2(1)/FilmCord2(3); FilmCord2y(i)=FilmCord2(2)/FilmCord2(3); % Perspective projection
    ...
    FilmCord4x(i)=FilmCord4(1)/FilmCord4(3); FilmCord4y(i)=FilmCord4(2)/FilmCord4(3); % Perspective projection
